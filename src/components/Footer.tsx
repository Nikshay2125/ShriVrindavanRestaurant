      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="text-restaurant-gold font-display text-2xl font-bold">
              Culinary Canvas
            </Link>
            <p className="text-gray-400 text-sm">
              A culinary journey through artful cuisine and exceptional hospitality. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-400 hover:text-restaurant-gold transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/gallery" className="text-gray-400 hover:text-restaurant-gold transition-colors">
                  Gallery
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-restaurant-gold transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400 space-y-2">
              ...
              <p>Email: info@culinarycanvas.com</p>
            </address>
          </div>
        </div>
